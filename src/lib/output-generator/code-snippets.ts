...
export function generateCodeSnippets(finding: AgentFinding): CodeSnippet[] {
  ...
  if (finding.category === "accessibility") {
    if (
      finding.description.toLowerCase().includes("alt text") ||
      finding.description.toLowerCase().includes("missing alt")
    ) {
      snippets.push({
        language: "html",
    ...
    if (
      finding.description.toLowerCase().includes("aria-label") ||
      finding.description.toLowerCase().includes("missing label")
    ) {
      snippets.push({
        language: "html",
    ...
    if (
      finding.description.toLowerCase().includes("focus") ||
      finding.description.toLowerCase().includes("keyboard")
    ) {
      snippets.push({
        language: "css",
  ...
  if (
    ...
    if (
      ...
      finding.description.toLowerCase().includes("button size")
    ) {
      snippets.push({
        language: "tailwind",
    ...
    if (
      finding.description.toLowerCase().includes("hick's law") ||
      finding.description.toLowerCase().includes("too many choices")
    ) {
      snippets.push({
        language: "jsx",
    ...
    if (
      finding.description.toLowerCase().includes("progress") ||
      finding.description.toLowerCase().includes("goal gradient")
    ) {
      snippets.push({
        language: "jsx",
  ...
  if (finding.category === "conversion") {
    if (
      finding.description.toLowerCase().includes("cta") ||
      finding.description.toLowerCase().includes("call to action")
    ) {
      snippets.push({
        language: "tailwind",
    ...
    if (
      finding.description.toLowerCase().includes("social proof") ||
      finding.description.toLowerCase().includes("testimonial")
    ) {
      snippets.push({
        language: "jsx",
