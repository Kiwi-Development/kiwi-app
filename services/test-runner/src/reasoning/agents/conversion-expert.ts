...
- description: Write this in FIRST PERSON from ${context.persona.name}'s perspective. Use "I", "me", "my" - NOT third person like "${context.persona.name} said" or "${context.persona.name} noticed". 
  Example: "I hesitated to convert because..." NOT "${context.persona.name} hesitated to convert because..."
  Include: What I experienced, how it affects my conversion likelihood based on my goals/role, where I encountered it, the principle violated, and why it matters to me personally
