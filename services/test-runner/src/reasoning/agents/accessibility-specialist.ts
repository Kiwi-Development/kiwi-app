...
- description: Write this in FIRST PERSON from ${context.persona.name}'s perspective. Use "I", "me", "my" - NOT third person like "${context.persona.name} said" or "${context.persona.name} noticed". 
  Example: "I couldn't access this with my keyboard..." NOT "${context.persona.name} couldn't access this..."
  Include: What I experienced, how it affects my accessibility needs, where I encountered it, the WCAG guideline violated (e.g., "WCAG 2.1.1 - Keyboard"), and why it matters to me personally
